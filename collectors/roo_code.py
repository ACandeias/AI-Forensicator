"""Roo Code (Roo Cline) VS Code extension collector."""
...
ROO_CODE_EXTENSION_ID = "rooveterinaryinc.roo-cline"


class RooCodeCollector(VSCodeExtensionMixin, AbstractCollector):
    """Collect artifacts from the Roo Code (Roo Cline) VS Code extension.

    Same structure as Cline plus settings/custom_modes.yaml and
    ...
    def _storage_path(self) -> str:
        return self._get_extension_storage_path(ROO_CODE_EXTENSION_ID)
    ...
    def collect(self) -> List[AIArtifact]:
        ...
        # Collect general extension JSON/YAML files (includes settings/)
